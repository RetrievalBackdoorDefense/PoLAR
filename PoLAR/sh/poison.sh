...
output_dir=${data_dir}/${dataset_name}_test

cd ${root_dir}/poison
python main.py \
    --device ${device} \
    --attack_method ${attack_method} \
    --clean_train_data_path ${data_dir}/${dataset_name}/${dataset_name}-train.jsonl \
    --clean_test_data_path ${data_dir}/${dataset_name}/${dataset_name}-dev.jsonl \
