...
class BadActsLocalDefender:
    ...
    def detect_defense(self, cfg, **kwargs):
        ...
        dev_H, _, _ = get_hidden_state(dev_iterator, "dev")

        defender = selectDefender(cfg.defense.name)()
        defense_output = defender.detect(train_H, dev_H, train_poisoned_labels)
        no_valid_questions = [
