...
export root_dir="/home/hust-ls/worksapce/PositiveFeedback/PositiveFeedback"
...
output_dir=/data/hust-ls/output/${pretrain_model}/${dataset_name}/${attack_method}/${poison_rate}/${sampling_method}/${distance_metric}/${loss_function}/capacity-${train_capacity}/epochs-${epochs}/train-mode-${train_mode}/defense-${defense_method}_TEST

mkdir -p ${output_dir}

# cd ${root_dir}
cd /home/hust-ls/worksapce/PositiveFeedback
